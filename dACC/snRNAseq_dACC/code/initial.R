...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "UMAP-HARMONY", XAxis = 1L,
                                          ...
                                          ColorByColumnData = "cellType_azimuth", ColorByFeatureNameAssay = "logcounts",
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data",
                                      XAxisColumnData = "cellType_azimuth", XAxisFeatureName = "ADRA1A",
                                      XAxisFeatureSource = "---", XAxisFeatureDynamicSource = FALSE,
                                      YAxisFeatureName = "ADRA1A", YAxisFeatureSource = "---",
                                      YAxisFeatureDynamicSource = FALSE, FacetRowByColData = "sort",
                                      FacetColumnByColData = "sort", ColorByColumnData = "cellType_azimuth",
...
initial[["ComplexHeatmapPlot1"]] <- new("ComplexHeatmapPlot", Assay = "logcounts", CustomRows = TRUE,
                                        CustomRowsText = c("CUX2", "ADCYAP1", "VAT1L", "GABRQ", "ROR1B", "CASC15", "PCP4",
                                                           "HTR2C", "SGCG", "SEMA5A", "GPR6", "CCN4", "CUX1", "SEMA6D","ZFHX3", "NXPH4"),
                                        ClusterRows = FALSE, ClusterRowsDistance = "spearman",
                                        ClusterRowsMethod = "ward.D2", DataBoxOpen = FALSE, VisualChoices = "Annotations",
                                        ColumnData = "cellType_azimuth", RowData = character(0), CustomBounds = FALSE,
