...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/LC/locus-c_Visium/LC_Shiny.RData"
if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    load(posit_connect_file)
} else {
    load(here::here("LC", "locus-c_Visium", "processed-data", "LC_Shiny.RData"))
}
