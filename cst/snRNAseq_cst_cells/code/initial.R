...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "HARMONY_UMAP", XAxis = 1L,
                                          YAxis = 2L, FacetRowByColData = "sort", FacetColumnByColData = "sort",
                                          ColorByColumnData = "lieden_k25", ColorByFeatureNameAssay = "logcounts",
                                          ...
                                          ColorByDefaultColor = "#000000", ColorByFeatureName = "Sst",
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data",
                                      XAxisColumnData = "lieden_k25", XAxisFeatureName = "---",
                                      XAxisFeatureSource = "---", XAxisFeatureDynamicSource = FALSE,
                                      YAxisFeatureName = "Sst", YAxisFeatureSource = "---",
                                      YAxisFeatureDynamicSource = FALSE, FacetRowByColData = "sort",
                                      FacetColumnByColData = "sort", ColorByColumnData = "lieden_k25",
...
initial[["ComplexHeatmapPlot1"]] <- new("ComplexHeatmapPlot", Assay = "logcounts", CustomRows = TRUE,
                                        CustomRowsText = c("Snap25","Slc17a7","Gad1","Sst","Pvalb", "Vip", "Lamp5","Chodl"), 
                                        ClusterRows = FALSE, ClusterRowsDistance = "spearman", 
                                        ClusterRowsMethod = "ward.D2", DataBoxOpen = FALSE, VisualChoices = "Annotations",
                                        ColumnData = "lieden_k25", RowData = character(0), CustomBounds = FALSE,
