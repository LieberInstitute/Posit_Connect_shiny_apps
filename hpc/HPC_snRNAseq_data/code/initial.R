...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "UMAP", XAxis = 1L, YAxis = 2L,
                                          ...
                                          CustomLabels = FALSE, CustomLabelsText = "1_AAACCCACAACGATCT-1",
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data",
                                      XAxisColumnData = "fine.cell.class", XAxisFeatureName = "TTR",
                                      XAxisFeatureSource = "---", XAxisFeatureDynamicSource = FALSE,
                                      YAxisFeatureName = "SNAP25", YAxisFeatureSource = "---",
                                      YAxisFeatureDynamicSource = FALSE, FacetRowByColData = "Sample",
                                      FacetColumnByColData = "Sample", ColorByColumnData = "fine.cell.class",
                                      ...
                                      LabelCentersColor = "#000000", VersionInfo = list(iSEE = structure(list(
                                          c(2L, 20L, 0L)), class = c("package_version", "numeric_version"
                                          ))), PanelId = 1L, PanelHeight = 500L, PanelWidth = 8L, SelectionBoxOpen = FALSE,
                                      RowSelectionSource = "---", ColumnSelectionSource = "---",
                                      DataBoxOpen = FALSE, RowSelectionDynamicSource = FALSE, ColumnSelectionDynamicSource = FALSE,
                                      RowSelectionRestrict = FALSE, ColumnSelectionRestrict = FALSE,
                                      SelectionHistory = list())
...
initial[["ComplexHeatmapPlot2"]] <- new("ComplexHeatmapPlot", Assay = "logcounts", CustomRows = TRUE,
                                        ...
                                        ColumnData = "fine.cell.class", RowData = character(0), CustomBounds = FALSE,
