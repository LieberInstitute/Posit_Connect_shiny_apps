...
# setwd(here::here('code', '04_shiny', 'MD_cell'))

setwd('/r_data/lcollado/Posit_Connect_shiny_apps/illumina_MD_cell')
...
main_cluster_var = 'banksy_lam0_2_res1_05'
...
spe = qs_read('spe.qs2')
spe_pb = qs_read('spe_pb_cell.qs2')
modeling_results = qs_read('modeling_results_cell.qs2')
sig_genes = qs_read('sig_genes_cell.qs2')
...
run_app(
    ...
    sig_genes = sig_genes,
    title = "Illumina Br8667 MD Cell Types",
