...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data", 
                                      XAxisColumnData = "DX", XAxisFeatureName = "A1BG, p-value=3.96e-02", 
                                      XAxisFeatureSource = "---", XAxisFeatureDynamicSource = FALSE, 
                                      YAxisFeatureName = "MAPK3, p-value=7.49e-04", YAxisFeatureSource = "---", 
                                      ...
                                      ColorByDefaultColor = "#000000", ColorByFeatureName = "A1BG, p-value=3.96e-02", 
