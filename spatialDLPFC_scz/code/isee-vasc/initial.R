...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data", 
                                      XAxisColumnData = "DX", XAxisFeatureName = "A2M, p-value=8.41e-06", 
                                      XAxisFeatureSource = "---", XAxisFeatureDynamicSource = FALSE, 
                                      YAxisFeatureName = "CD74, p-value=7.57e-03", YAxisFeatureSource = "---", 
                                      ...
                                      ColorByDefaultColor = "#000000", ColorByFeatureName = "A2M, p-value=8.41e-06", 
                                      ...
                                      PanelHeight = 580L, PanelWidth = 6L, SelectionBoxOpen = FALSE, 
...
initial[["FeatureAssayPlot2"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data", 
                                      ...
                                      LabelCenters = FALSE, LabelCentersBy = "sample_id", LabelCentersColor = "#000000", 
                                      VersionInfo = list(iSEE = structure(list(c(2L, 18L, 0L)), class = c("package_version", 
                                                                                                          "numeric_version"))), PanelId = 2L, PanelHeight = 580L, PanelWidth = 6L, 
