...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/itc/Visium_SPG_AD_TGE/spe.Rdata"
posit_connect_file1 <- "/r_data/lcollado/Posit_Connect_shiny_apps/itc/Visium_SPG_AD_TGE/Visium_SPG_AD_modeling_results.Rdata"
posit_connect_file2 <- "/r_data/lcollado/Posit_Connect_shiny_apps/itc/Visium_SPG_AD_TGE/sce_pseudo_pathology_targeted.rds"
...
if (file.exists(posit_connect_file)) {
    ...
    load(here::here("itc", "Visium_SPG_AD_TGE", "processed-data", "spe.Rdata"))
}
...
if (file.exists(posit_connect_file1)) {
    ...
    load(here::here("itc", "Visium_SPG_AD_TGE", "processed-data", "Visium_SPG_AD_modeling_results.Rdata"))
}
...
if (file.exists(posit_connect_file2)) {
    ...
    sce_pseudo <- readRDS(here::here("itc", "Visium_SPG_AD_TGE", "processed-data", "sce_pseudo_pathology_targeted.rds"))
}
