...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/spatial_hpc/processed-data/spe_norm_with_domain_filtered.rds"
if (file.exists(posit_connect_file)) {
  ## Location for the https://conn1.libd.org/ server
  spe <- readRDS(posit_connect_file)
} else {
  spe <- readRDS(here::here("spatial_hpc/processed-data/06_clustering/PRECAST/spe_norm_with_domain_filtered.rds"))
}
