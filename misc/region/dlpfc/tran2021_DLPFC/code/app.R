...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/dlpfc/tran2021_DLPFC/sce_dlpfc_small.rds"
if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    sce_small <- readRDS(posit_connect_file)
} else {
    sce_small <- readRDS(here::here("misc", "region", "dlpfc", "tran2021_DLPFC", "processed-data", "sce_dlpfc_small.rds"))
}

posit_connect_file1 <- "/r_data/lcollado/Posit_Connect_shiny_apps/dlpfc/tran2021_DLPFC/cell_colors_dlpfc.rds"
if (file.exists(posit_connect_file1)) {
    ## Location for the https://conn1.libd.org/ server
    cell_colors <- readRDS(posit_connect_file1)
} else {
    cell_colors <- readRDS(here::here("misc", "region", "dlpfc", "tran2021_DLPFC", "processed-data", "cell_colors_dlpfc.rds"))
}
...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "PCA_corrected", XAxis = 1L,
                                          ...
                                          ColorByFeatureDynamicSource = FALSE, ColorBySampleName = "donor6_AAACCCACAGTCGTTA.1",
                                          ...
                                          CustomLabelsText = "donor6_AAACCCACAGTCGTTA.1", FontSize = 1,
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data",
                                      ...
                                      CustomLabels = FALSE, CustomLabelsText = "donor6_AAACCCACAGTCGTTA.1",
...
iSEE(
    sce_small,
    appTitle = "M.N. Tran et al 2021, DLPFC region https://bit.ly/LIBD10xHuman",
    initial = initial,
