...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/dlpfc/tran2020_DLPFC/sce_dlpfc_small.rds"
if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    sce <- readRDS(posit_connect_file)
} else {
    sce <- readRDS(here::here("misc", "region", "dlpfc", "tran2020_DLPFC", "processed-data", "sce_dlpfc_small.rds"))
}
