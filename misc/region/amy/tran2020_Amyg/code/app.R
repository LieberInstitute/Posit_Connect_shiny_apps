...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/amy/tran2020_Amyg/sce_amyg_small.rds"
if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    sce <- readRDS(posit_connect_file)
} else {
    sce <- readRDS(here::here("misc", "region", "amy", "tran2020_Amyg", "processed-data", "sce_amyg_small.rds"))
}
