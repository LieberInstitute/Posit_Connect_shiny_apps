...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/nac/tran2020_NAc/sce_nac_small.rds"
if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    sce <- readRDS(posit_connect_file)
} else {
    sce <- readRDS(here::here("misc", "region", "nac", "tran2020_NAc", "processed-data", "sce_nac_small.rds"))
}
...
iSEE(sce, appTitle = "M.N. Tran et al 2020, NAc region https://bit.ly/LIBD10xHuman", initial = initial)
