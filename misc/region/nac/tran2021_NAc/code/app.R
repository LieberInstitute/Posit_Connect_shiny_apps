...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/nac/tran2021_NAc/sce_nac_small.rds"
if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    sce_small <- readRDS(posit_connect_file)
} else {
    sce_small <- readRDS(here::here("misc", "region", "nac", "tran2021_NAc", "processed-data", "sce_nac_small.rds"))
}

posit_connect_file1 <- "/r_data/lcollado/Posit_Connect_shiny_apps/nac/tran2021_NAc/cell_colors_nac.rds"
if (file.exists(posit_connect_file1)) {
    ## Location for the https://conn1.libd.org/ server
    cell_colors <- readRDS(posit_connect_file1)
} else {
    cell_colors <- readRDS(here::here("misc", "region", "nac", "tran2021_NAc", "processed-data", "cell_colors_nac.rds"))
}
...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "PCA_corrected", XAxis = 1L,
                                          ...
                                          ColorByFeatureDynamicSource = FALSE, ColorBySampleName = "donor1_AAACCCACATCGAACT.1",
                                          ...
                                          CustomLabelsText = "donor1_AAACCCACATCGAACT.1", FontSize = 1,
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data",
                                      ...
                                      CustomLabels = FALSE, CustomLabelsText = "donor1_AAACCCACATCGAACT.1",
...
iSEE(
    sce_small,
    appTitle = "M.N. Tran et al 2021, NAc region https://bit.ly/LIBD10xHuman",
    initial = initial,
