...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/hpc/tran2020_HPC/sce_hpc_small.rds"
if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    sce <- readRDS(posit_connect_file)
} else {
    sce <- readRDS(here::here("misc", "region", "hpc", "tran2020_HPC", "processed-data", "sce_hpc_small.rds"))
}
