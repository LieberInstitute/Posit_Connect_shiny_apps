...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/misc/Visium_SPG_AD_pseudobulk_AD_pathology_wholegenome/sce_pseudo_pathology_wholegenome.rds"
...
if (file.exists(posit_connect_file)) {
    ...
    sce_IF <- readRDS(here::here("misc", "Visium_SPG_AD_pseudobulk_AD_pathology_wholegenome", "processed-data", "sce_pseudo_pathology_wholegenome.rds"))
}


source("https://github.com/LieberInstitute/Posit_Connect_shiny_apps/blob/devel/misc/Visium_SPG_AD_pseudobulk_AD_pathology_wholegenome/code/initial.R?raw=TRUE")
