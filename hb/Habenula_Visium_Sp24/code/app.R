...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/hb/Habenula_Visium_Sp24/sig_genes_k24.Rdata"
posit_connect_file1 <- "/r_data/lcollado/Posit_Connect_shiny_apps/hb/Habenula_Visium_Sp24/modeling_results_BayesSpace_k24.Rdata"
posit_connect_file2 <- "/r_data/lcollado/Posit_Connect_shiny_apps/hb/Habenula_Visium_Sp24/sce_pseudo_BayesSpace_k24.rds"
posit_connect_file3 <- "/r_data/lcollado/Posit_Connect_shiny_apps/hb/Habenula_Visium_Sp24/spe_subset_for_spatialLIBD.rds"

if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    load(posit_connect_file)
} else {
    load(here::here("hb", "Habenula_Visium_Sp24", "processed-data", "sig_genes_k24.Rdata"))
}
...
if (file.exists(posit_connect_file1)) {
    ...
    load(here::here("hb", "Habenula_Visium_Sp24", "processed-data", "modeling_results_BayesSpace_k24.Rdata"))
}
...
if (file.exists(posit_connect_file2)) {
    ...
    sce_pseudo <- readRDS(here::here("hb", "Habenula_Visium_Sp24", "processed-data", "sce_pseudo_BayesSpace_k24.rds"))
}
...
if (file.exists(posit_connect_file3)) {
    ...
    spe <- readRDS(here::here("hb", "Habenula_Visium_Sp24", "processed-data", "spe_subset_for_spatialLIBD.rds"))
}
