...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "TSNE", XAxis = 1L, YAxis = 2L, 
                                          ...
                                          ColorByColumnData = "prelimClust.10", ColorByFeatureNameAssay = "logcounts", 
                                          ...
                                          ColorBySampleName = "1_AAACCCAAGAAATTCG-1", ColorBySampleSource = "---", 
                                          ...
                                          CustomLabelsText = "1_AAACCCAAGAAATTCG-1", FontSize = 1, 
...
initial[["ComplexHeatmapPlot1"]] <- new("ComplexHeatmapPlot", Assay = "logcounts", CustomRows = TRUE, 
                                        ...
                                        DataBoxOpen = FALSE, VisualChoices = "Annotations", ColumnData = c("projection", 
                                                                                                           "prelimClust.10", "prelimClust.15", "prelimClust.20"), RowData = character(0), 
...
initial[["RowDataTable1"]] <- new("RowDataTable", Selected = "ENSMUSG00000027273", Search = "", 
                                  SearchColumns = c("", "", "", "", "", "", ""), HiddenColumns = character(0), 
                                  VersionInfo = list(iSEE = structure(list(c(2L, 14L, 0L)), class = c("package_version", 
                                                                                                      "numeric_version"))), PanelId = c(RowDataTable = 1L), PanelHeight = 760L, 
                                  PanelWidth = 4L, SelectionBoxOpen = FALSE, RowSelectionSource = "---", 
                                  ColumnSelectionSource = "---", DataBoxOpen = FALSE, RowSelectionDynamicSource = TRUE, 
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data", 
                                      XAxisColumnData = "prelimClust.10", XAxisFeatureName = "ENSMUSG00000051951", 
                                      XAxisFeatureSource = "---", XAxisFeatureDynamicSource = FALSE, 
                                      YAxisFeatureName = "ENSMUSG00000027273", YAxisFeatureSource = "RowDataTable1", 
                                      YAxisFeatureDynamicSource = FALSE, FacetRowByColData = "projection", 
                                      FacetColumnByColData = "Sample", ColorByColumnData = "prelimClust.10", 
                                      ...
                                      ColorByFeatureDynamicSource = FALSE, ColorBySampleName = "1_AAACCCAAGAAATTCG-1", 
                                      ...
                                      PanelHeight = 760L, PanelWidth = 8L, SelectionBoxOpen = FALSE, 
                                      RowSelectionSource = "---", ColumnSelectionSource = "---", 
                                      DataBoxOpen = FALSE, RowSelectionDynamicSource = FALSE, ColumnSelectionDynamicSource = FALSE, 
                                      RowSelectionRestrict = FALSE, ColumnSelectionRestrict = FALSE, 
                                      SelectionHistory = list())