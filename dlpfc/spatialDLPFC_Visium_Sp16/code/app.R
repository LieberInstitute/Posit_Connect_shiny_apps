...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/dlpfc/spatialDLPFC_Visium_Sp16/sig_genes_subset_k16.Rdata"
posit_connect_file1 <- "/r_data/lcollado/Posit_Connect_shiny_apps/dlpfc/spatialDLPFC_Visium_Sp16/modeling_results_BayesSpace_k16.Rdata"
posit_connect_file2 <- "/r_data/lcollado/Posit_Connect_shiny_apps/dlpfc/spatialDLPFC_Visium_Sp16/sce_pseudo_BayesSpace_k16.rds"
posit_connect_file3 <- "/r_data/lcollado/Posit_Connect_shiny_apps/dlpfc/spatialDLPFC_Visium_Sp16/spe_subset_for_spatialLIBD.rds"

if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    load(posit_connect_file)
} else {
    load(here::here("dlpfc", "spatialDLPFC_Visium_Sp16", "processed-data", "sig_genes_subset_k16.Rdata"))
}
...
if (file.exists(posit_connect_file1)) {
    ...
    load(here::here("dlpfc", "spatialDLPFC_Visium_Sp16", "processed-data", "modeling_results_BayesSpace_k16.Rdata"))
}
...
if (file.exists(posit_connect_file2)) {
    ...
    sce_pseudo <- readRDS(here::here("dlpfc", "spatialDLPFC_Visium_Sp16", "processed-data", "sce_pseudo_BayesSpace_k16.rds"))
}
...
if (file.exists(posit_connect_file3)) {
    ...
    spe <- readRDS(here::here("dlpfc", "spatialDLPFC_Visium_Sp16", "processed-data", "spe_subset_for_spatialLIBD.rds"))
}
...
spatialLIBD::run_app(
    ...
    sig_genes = sig_genes,
    title = "spatialDLPFC, Visium, Sp16",
