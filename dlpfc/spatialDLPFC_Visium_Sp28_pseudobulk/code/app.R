...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/dlpfc/spatialDLPFC_Visium_Sp28_pseudobulk/sce_pseudo_BayesSpace_k28.rds"
...
if (file.exists(posit_connect_file)) {
    ...
    sce_pseudo <- readRDS(here::here("dlpfc", "spatialDLPFC_Visium_Sp28_pseudobulk", "processed-data", "sce_pseudo_BayesSpace_k28.rds"))
}

source("https://github.com/LieberInstitute/Posit_Connect_shiny_apps/blob/devel/dlpfc/spatialDLPFC_Visium_Sp28_pseudobulk/code/initial.R?raw=TRUE")
