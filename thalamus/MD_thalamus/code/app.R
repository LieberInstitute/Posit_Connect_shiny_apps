...
## Load the data
posit_connect_file <- "/r_data/lcollado/Posit_Connect_shiny_apps/thalamus/MD_Thalamus/spe_clustered"
if (file.exists(posit_connect_file)) {
    ## Location for the https://conn1.libd.org/ server
    spe <- HDF5Array::loadHDF5SummarizedExperiment(posit_connect_file)
} else {
    spe <- HDF5Array::loadHDF5SummarizedExperiment(here::here("thalamus", "MD_thalamus", "processed-data", "spe_clustered"))
}
