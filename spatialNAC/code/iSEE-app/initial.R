...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data", 
                                      ...
                                      ShapeByColumnData = "Sample", SizeByColumnData = NA_character_, 
                                      TooltipColumnData = character(0), FacetRowBy = "None", FacetColumnBy = "None", 
                                      ColorBy = "Column data", ColorByDefaultColor = "#000000", 
                                      ColorByFeatureName = "KCNIP4", ColorByFeatureSource = "---", 
                                      ColorByFeatureDynamicSource = FALSE, ColorBySampleName = "1_AAACCCAAGACCAACG-1", 
...
initial[["ComplexHeatmapPlot1"]] <- new("ComplexHeatmapPlot", Assay = "logcounts", CustomRows = TRUE, 
                                        ...
                                        ColumnData = "CellType.Final", RowData = character(0), CustomBounds = TRUE, 
                                        LowerBound = -5L, UpperBound = 5L, AssayCenterRows = TRUE, 
